...
const Tickets = () => {
  ...
  if (!userData) {
    return (
      <div className="w-full h-full flex items-center justify-center">
        <button class="text-zinc-500 hover:text-zinc-200 backdrop-blur-lg animate-pulse-er bg-gradient-to-tr from-transparent via-[rgba(121,121,121,0.16)] to-transparent rounded-md py-2 px-6 shadow hover:shadow-zinc-400 duration-700">
  ...
  return (
    ...
    >
      ...
      <button class="cursor-pointer absolute bottom-10 right-10 bg-gray-800 px-3 py-2 rounded-md text-white tracking-wider shadow-xl animate-bounce hover:animate-none">
        <svg
          class="w-5 h-5"
          stroke="currentColor"
          stroke-width="2"
